...
// Rendered in a portal above everything; closes on Escape or backdrop click
// and locks page scroll while open.
export default function Modal({ open, onClose, title, className = '', children, footer }: ModalProps) {
  useEffect(() => {
    if (!open) return;
